...
<body>
    ...
    if (isset($_GET['habitaciones'])) {
        ...
        if (isset($_SESSION['usuario'])) {
            ...
            echo "La sesión está activa para el usuario " . $_SESSION['usuario'];
        } else {
    ...
    if (isset($_GET['sesion'])) {
        ...
        echo "<script>
            ...
            boton.click(function(){
                ...
                window.location.href = 'http://localhost/DWES/ProyectoFinDeGrado/ProyectoFinDeGrado-1/php/inicio.php?registrar';
