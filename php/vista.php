    ...
    class View
    {
        ...
        public function cabecera()
        {
            ...
            if (isset($_SESSION['usuario'])) {
                ...
                $id = "cerrarSesion";
                $url = "http://localhost/DWES/ProyectoFinDeGrado/ProyectoFinDeGrado-1/php/inicio.php?cerrarSesion";
            } else {
                $sesionUsuario = "Iniciar Sesion";
                $id = "sesion";
                $url = "http://localhost/DWES/ProyectoFinDeGrado/ProyectoFinDeGrado-1/php/inicio.php?sesion";
            }
                ...
                <nav>
                    <div class="container">
                        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                            ...
                            <ul id="menu" class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                                <li>
                                    <strong><a id="init" href="http://localhost/DWES/ProyectoFinDeGrado/ProyectoFinDeGrado-1/php/inicio.php" class="nav-link px-2 text-light">Inicio</a></strong>
                                </li>

                                <li>
                                    <strong><a id="habitaciones" href="http://localhost/DWES/ProyectoFinDeGrado/ProyectoFinDeGrado-1/php/inicio.php?habitaciones" class="nav-link px-2 text-light">Habitaciones</a></strong>
                                </li>

                                <li>
                                    <strong><a id="contacto" href="http://localhost/DWES/ProyectoFinDeGrado/ProyectoFinDeGrado-1/php/inicio.php?contacto" class="nav-link px-2 text-light">Contacto</a></strong>
                                </li>
        ...
        {
            echo '<p class="d-flex justify-content-center mb-5 mt-5">Estos son los diferentes servicios que puedes encontrar en nuestro hotel:</p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="formContacto" class="needs-validation" novalidate>
                                    ...
                                    <a href="http://localhost/DWES/ProyectoFinDeGrado/ProyectoFinDeGrado-1/php/inicio.php" class="btn btn-primary mt-2">Volver</a>
                                </form>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="formRegistro" class="needs-validation" novalidate>
                                    ...
                                    <a href="http://localhost/DWES/ProyectoFinDeGrado/ProyectoFinDeGrado-1/php/inicio.php?sesion" class="btn btn-primary mt-2">Volver</a>
                                </form>
                            </div>
                        </div>
                    </div>
